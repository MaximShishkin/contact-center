	...
	private class startcalc {
		...
		boolean calc()
		{
			...
			qp=1-Double.parseDouble(textField_7.getText());
			 ...
			 //  mu=3; mu1=3; mu2=3;
			   c=0.2; c1=0.5; c2=0.5;
			   sigma=0.3; sigma1=0.25; sigma2=0.25;
			   ...
			   {  
				...
				//{construction of right part system of state equation: for state (j,i,i1,i2)}
				        ...
				        //  {blocking and subsequent stopping of  repeatition}
				          ...
				          if ((i==v+w) && (j<rm))   rp=rp+p[j+1][i][i1][i2]*(j+1)*nu*(1-h)*qr*a;
				          
				          if ((i1==v1+w1) && (j<rm))  rp=rp+p[j+1][i][i1][i2]*(j+1)*nu*(1-h)*qr*a1;
				           
				          if ((i2==v2+w2) && (j<rm))   rp=rp+p[j+1][i][i1][i2]*(j+1)*nu*(1-h)*qr*a2;
				      ...
				      //     {transition to the first group}
				          ...
				          if ((i+1<=v) && (i1==v1+w1) && (j<rm))   rp=rp+p[j][i+1][i1][i2]*(i+1)*mu*c*c1*(1-h);
				          
				          if ((i+1<=v) && (i1==v1+w1) && (j==rm)) rp=rp+p[j][i+1][i1][i2]*(i+1)*mu*c*c1;
				           
				          if ((i+1<=v) && (i1==v1+w1) && (j>0))  rp=rp+p[j-1][i+1][i1][i2]*(i+1)*mu*c*c1*h;
				          ...
				          if ((i+1<=v+w)  && (i+1>v) && (i1>0))  rp=rp+p[j][i+1][i1-1][i2]*v*mu*c*c1;
				           

				          if ((i+1<=v+w)  && (i+1>v) && (i1==v1+w1) && (j<rm))   rp=rp+p[j][i+1][i1][i2]*v*mu*c*c1*(1-h);
				          
				          if ((i+1<=v+w)  &&(i+1>v) && (i1==v1+w1) && (j==rm))    rp=rp+p[j][i+1][i1][i2]*v*mu*c*c1;
				         
				          if ((i+1<=v+w)  &&(i+1>v) && (i1==v1+w1) && (j>0))   rp=rp+p[j-1][i+1][i1][i2]*v*mu*c*c1*h;
				      ...
				      //   {transition to the second group}
				          ...
				          if ((i+1<=v) && (i2==v2+w2) && (j<rm))   rp=rp+p[j][i+1][i1][i2]*(i+1)*mu*c*c2*(1-h);
				          
				          if ((i+1<=v) && (i2==v2+w2) && (j==rm))  rp=rp+p[j][i+1][i1][i2]*(i+1)*mu*c*c2;
				           
				          if ((i+1<=v) && (i2==v2+w2) && (j>0))   rp=rp+p[j-1][i+1][i1][i2]*(i+1)*mu*c*c2*h;
				          




				          if ((i+1<=v+w)  && (i+1>v) && (i2>0))   rp=rp+p[j][i+1][i1][i2-1]*v*mu*c*c2;
				          


				          if ((i+1<=v+w)  && (i+1>v) && (i2==v2+w2) && (j<rm)) rp=rp+p[j][i+1][i1][i2]*v*mu*c*c2*(1-h);
				           
				          if ((i+1<=v+w)  && (i+1>v) && (i2==v2+w2) && (j==rm))   rp=rp+p[j][i+1][i1][i2]*v*mu*c*c2;
				          
				          if ((i+1<=v+w)  && (i+1>v) && (i2==v2+w2) && (j>0))   rp=rp+p[j-1][i+1][i1][i2]*v*mu*c*c2*h;
				    ...
				    //      {leaving of the waiting positions out of c-c or to repeatiton}
				          ...
				          if ((i+1<=v+w)  && (i+1>v) && (j<rm))  rp=rp+p[j][i+1][i1][i2]*(i+1-v)*sigma*(1-h);
				           
				          if ((i+1<=v+w)  && (i+1>v) && (j==rm))  rp=rp+p[j][i+1][i1][i2]*(i+1-v)*sigma;
				           
				          if ((i+1<=v+w)  && (i+1>v) && (j>0))  rp=rp+p[j-1][i+1][i1][i2]*(i+1-v)*sigma*h;
				           


				           if ((i1+1<=v1+w1)  && (i1+1>v1) && (j<rm))   rp=rp+p[j][i][i1+1][i2]*(i1+1-v1)*sigma1*(1-h);
				          
				          if ((i1+1<=v1+w1)  && (i1+1>v1) && (j==rm))   rp=rp+p[j][i][i1+1][i2]*(i1+1-v1)*sigma1;
				          
				          if ((i1+1<=v1+w1)  && (i1+1>v1) && (j>0))   rp=rp+p[j-1][i][i1+1][i2]*(i1+1-v1)*sigma1*h;
				          


				          if ((i2+1<=v2+w2)  && (i2+1>v2) && (j<rm))  rp=rp+p[j][i][i1][i2+1]*(i2+1-v2)*sigma2*(1-h);
				           
				          if ((i2+1<=v2+w2)  && (i2+1>v2) && (j==rm))  rp=rp+p[j][i][i1][i2+1]*(i2+1-v2)*sigma2;
				         
				          if ((i2+1<=v2+w2)  && (i2+1>v2) && (j>0))   rp=rp+p[j-1][i][i1][i2+1]*(i2+1-v2)*sigma2*h;
				...
				rb=0;rb1=0;rb2=0;rb11=0;rb22=0;
				rt=0;rt1=0;rt2=0;
				     ...
				     for(j=0;j<=rm;j++)
					    {
				          ...
				          if ((i+1<=v) && (i1==v1+w1) && (j==rm))  delta=delta+ p[j][i][i1][i2]*(i+1)*mu*c*c1*h;
				          if ((i+1<=v+w)  && (i+1>v) && (i1==v1+w1) && (j==rm))  delta=delta+ p[j][i][i1][i2]*v*mu*c*c1*h;

				          if ((i+1<=v) && (i2==v2+w2) && (j==rm)) delta=delta+ p[j][i][i1][i2]*(i+1)*mu*c*c2*h;
				          if ((i+1<=v+w)  && (i+1>v) && (i2==v2+w2) && (j==rm))  delta=delta+ p[j][i][i1][i2]*v*mu*c*c2*h;

				          if ((i+1<=v+w)  && (i+1>v) && (j==rm)) delta=delta+ p[j][i][i1][i2]*(i+1-v)*sigma*h;

				          if ((i1+1<=v1+w1)  && (i1+1>v1) && (j==rm)) delta=delta+ p[j][i][i1][i2]*(i1+1-v1)*sigma1*h;
				          if ((i2+1<=v2+w2)  && (i2+1>v2) && (j==rm)) delta=delta+ p[j][i][i1][i2]*(i2+1-v2)*sigma2*h;
				...
				//   (it is supposed that rm finite if not then delta=0)}
				 ...
				 //  System.out.println("dif1="+dif1);
				  ...
				  // System.out.println("dif3="+dif3);
				   ...
				   System.out.println("ƒол€ необслужанных запросов ="+pct);
				   System.out.println("—реднее врем€ обслуживани€ в системе="+twt);
				   //System.out.println(""+mwt);
				   System.out.println("—реднее количество запросов на обслуживание ="+mit);
				   System.out.println("ƒол€ потер€нных запросов, приход€щих от операторов"+pc);
				   System.out.println("Cреднее количество зан€тых операторов = "+mi);
				   System.out.println("—реднее врем€ нахождени€ в системе, операторы "+tw);
				  // System.out.println("—реднее количество зан€тых мест ожидани€ у операторов = "+mw);
				  
				   System.out.println("ƒол€ необслужанных запросов, 1= "+pc1);
				   System.out.println("—реднее врем€ нахождени€ в системе, 1 ="+tw1);
				   //System.out.println("mw1="+mw1);
				   System.out.println("—реднее количество зан€тых, 1 = "+mi1);
				   
				   System.out.println("ƒол€ необслужанных запросов, 2= "+pc2);
				   System.out.println("—реднее врем€ нахождени€ в системе, 2 = "+tw2);
				   //System.out.println("mw2="+mw2);
				   System.out.println("—реднее количество зан€тых, 2 = "+mi2);
